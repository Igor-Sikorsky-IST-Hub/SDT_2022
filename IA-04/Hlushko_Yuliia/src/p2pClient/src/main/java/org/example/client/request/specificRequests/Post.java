...
public class Post extends Request {
    ...
    public Request requestProcess() {
        Statistic.loadStatistic(ConfigurationManager.getInstance().getCurrentConfiguration().getStatisticDirectoryPath());
        ...
        Statistic.saveStatistic(ConfigurationManager.getInstance().getCurrentConfiguration().getStatisticDirectoryPath());
        return this;
