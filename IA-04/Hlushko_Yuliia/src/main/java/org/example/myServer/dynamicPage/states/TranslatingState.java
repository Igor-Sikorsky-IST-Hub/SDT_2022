...
public class TranslatingState extends DynamicPageState {
    ...
    public TranslatingState(Page page) {
        super(page);
        ...
        this.data=page.getParameters();
    }

    @Override
    public void doAction() {
       super.page.setTranslatedPage(translate());
       super.page.changeState(new MakingSourceFileState(super.page));
    }
    private String translate() {
        translatedPage = translatedPage + "package dynamicPage;\n" +
                ...
                "public class " + newClassName + " implements org.example.myServer.dynamicPage.GeneralInterfaceForTranslatedPages {\n" +
                "public " + newClassName + " (){}\n" +
                "public void toDo() { \n" +
    ...
    private String checkPostVariable(String string) {
        ...
        if (this.data != null && data.get(newExpression) != null)
            return string.replace(expression, "\"" + data.get(newExpression).replaceAll("\\W","") + "\"");
        else return string.replace(expression, "\" \"");
    }
